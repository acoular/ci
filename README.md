...
## Python versions
- The workflows assumes that there exists a repository variable `SUPPORTED_PYTHON_VERSIONS=['3.10','3.11','3.12','3.13']` and `LATEST_PYTHON_VERSION='3.13'` or similar that lists the supported Python versions of the package.
